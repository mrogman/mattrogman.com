...
/***/ function(module, exports, __webpack_require__) {
	...
	//styles
	__webpack_require__(1)(stylesDir + 'style.scss');
	
	//scripts
	main = __webpack_require__(6)(coffeeDir + 'main.coffee');
	Background = __webpack_require__(8)(coffeeDir + 'background.coffee');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./public/stylesheets/style.scss": 2
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./public/coffeescripts/main.coffee": 7
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
...
/***/ function(module, exports) {
	...
	$(function() {
	  var $accountIcons, $contentBox, $contentInner, iconHighlight, startIconHighlight;
	  Background.init();
	  ...
	  window.setTimeout(function() {
	    ...
	    return $contentBox.css({
	      ...
	      return $contentInner.fadeIn('fast', function() {
	        return setTimeout(iconHighlight, 500);
	      });
	    });
	  }, 400);
	  iconHighlight = function() {
	    return $accountIcons.each(function(i, icon) {
	      var interval;
	      interval = i * 100;
	      return window.setTimeout(function() {
	        return $(icon).trigger('mouseenter').delay(200).trigger('mouseleave');
	      }, interval);
	    });
	  };
	  ...
	  $accountIcons.parent('a').on({
	    mouseenter: function() {
	      clearInterval(startIconHighlight);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var map = {
		"./public/coffeescripts/background.coffee": 9
	};
	function webpackContext(req) {
		return __webpack_require__(webpackContextResolve(req));
	};
